...
export function CheckoutFooter({
  ...
  return (
    <div className="fixed bottom-0 left-1/2 w-full max-w-[480px] -translate-x-1/2 border-t border-zinc-200 bg-white px-4 py-4">
      ...
      <div className="mb-2 flex justify-between text-xl font-semibold text-zinc-900">
        <span>Total</span>
      ...
      <button
        onClick={onConfirm}
        disabled={disabled}
        className="w-full rounded-xl bg-[var(--brand-primary)] px-4 py-3.5 text-base font-semibold text-white disabled:cursor-not-allowed disabled:bg-zinc-300"
      >
        ✓ Confirmar pedido
      </button>
    </div>
