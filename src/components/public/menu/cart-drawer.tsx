    ...
    <>
      ...
      >
        <div className="flex items-center justify-between border-b border-zinc-100 px-5 py-4">
          <div className="text-base font-semibold text-zinc-900">Seu carrinho</div>

          <button
            onClick={onClose}
            className="flex h-7 w-7 items-center justify-center rounded-lg bg-zinc-100 text-sm text-zinc-500"
          >
            ✕
          </button>
        </div>
        ...
        <div className="max-h-[50vh] overflow-y-auto px-5 py-4">
          {items.map((item) => (
            ...
            >
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-zinc-100 text-base">
                {item.emoji}
              </div>
              ...
              <div className="w-16 text-right text-sm font-semibold text-zinc-900">
